...
void ATopDownCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ATopDownCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ATopDownCharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ATopDownCharacter::OnResetVR);
}


void ATopDownCharacter::OnResetVR()
{
	// If TopDown is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in TopDown.Build.cs is not automatically propagated
...
void ATopDownCharacter::TurnAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void ATopDownCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
